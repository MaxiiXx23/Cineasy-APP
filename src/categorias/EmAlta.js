...
class EmAlta extends React.Component {
    ...
    loadRepositories = async () =>{
        ...
        const api = ip;
        return fetch(`${api}/filmes/listaemalta/${page}`)
                        ...
                        <TouchableHighlight onPress={() => {
                            ...
                            <View style={{ backgroundColor: '#191919', height: 240, borderColor: 'transparent',marginBottom:5 }} >
                                <View style={{ backgroundColor: '#191919', height: 250, marginLeft: 5}} >
                                    <Image source={{ uri: api + '/filmes/poster/' + item.foto }} style={{ height: 240, width: 200 }} /></View>
                            </View>
                        </TouchableHighlight>
                    }
...
export default class EmAltaStack extends React.Component {
    render() {
        return <AppContainer />;
    }
}